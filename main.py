...
def get_args():
    ...
    parser.add_argument('--config', type=str, default="./config/csgnn_sichuan.yml", help='path to the config file')
...
def main(args):
    ...
    for epoch in range(args.max_epoch):
        ...
        loss_cost = torch.pow(torch.norm(T-cost.cost_matrix),2)+val_err
